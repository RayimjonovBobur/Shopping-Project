...
import {AppStore, Email, Fecebook, GooglePlay, Instagram, Location, Phone, Telegram} from "../../utilities/icons";
import './Footer.scss'
      ...
      <div className={'footer-content-items'}>
              <div className={'footer-content-item'}>
                  ...
                  <div className={'footer-content-text'}>
                      ...
                      <p>
                          12 yoki 18 oy davomida oldindan to'lov yo'q
                      </p>
                  </div>
              </div>
        <div className={'footer'}>
            ...
            '>
                         ...
                         <div className='col-md-6'>
                             <div className={'footer-content_row'}>
                                 ...
                                 <a href="#">
                                     <Phone/>+998913960213</a>
                                 <a href="#">
                                     <Email/>info@imsoft.uz</a>
                                 <a href="#">
                                     <Location/> Farg`ona</a>
                             </div>
                         </div>
            ...
            <hr className={'footer-content-hr'}/>
            <p className={'footer-text'}>2015 Internet-do’kon: Maishiy texnikalar va boshqalar.Mahsulotni yetkazib berish barcha viloyatlarda amalga oshiriladi. Barcha huquqlar himoyalangan.</p>
        </div>
      </div>
    </>
  );
